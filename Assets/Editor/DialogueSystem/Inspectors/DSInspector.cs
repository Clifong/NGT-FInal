...
namespace DS.Inspectors
{
    ...
    public class DSInspector : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            {
                List<string> dialogueGroupNames = currentDialogueContainer.GetGroupNames();
                ...
                DSGroupSO dialogueGroup = (DSGroupSO) dialogueGroupProperty.objectReferenceValue;
        ...
        private void DrawDialogueGroupArea(DSDialogueContainerSO dialogueContainer, List<string> dialogueGroupNames)
        {
            ...
            DSGroupSO oldDialogueGroup = (DSGroupSO) dialogueGroupProperty.objectReferenceValue;
            ...
            DSGroupSO selectedDialogueGroup = DSIOUtility.LoadAsset<DSGroupSO>($"Assets/DialogueSystem/Dialogues/{dialogueContainer.FileName}/Groups/{selectedDialogueGroupName}", selectedDialogueGroupName);
